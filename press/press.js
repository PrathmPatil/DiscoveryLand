window.addEventListener("DOMContentLoaded",function(){
    ...
    var counter=0;
        ...
        main_texttitle.textContent=title_discription[0].title;
        main_content.textContent=title_discription[0].discription;
    ...
    right_btn.addEventListener("click",function(){
        ...
        // else if(counter>=title_discription.length-1)
        // {
        //     main_texttitle.textContent=title_discription[counterTwo].title;
        //     main_content.textContent=title_discription[counterTwo].discription;
        //     counterTwo +=1; 
        // }
        // if(counterTwo>=4){
        //     counterTwo=0;
